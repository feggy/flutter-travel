...
class UbahAgendaPage extends StatefulWidget {
  int dayNumber;
  AgendaModel agenda;
  ...
  @override
  _UbahAgendaPageState createState() => _UbahAgendaPageState();
}

class _UbahAgendaPageState extends State<UbahAgendaPage> {
  ...
  TextEditingController dayOfNumberController = TextEditingController(text: '');
  ...
  void initState() {
    ...
    timeStart = widget.agenda.startTime;
    timeEnd = widget.agenda.endTime;
    deskripsiController.text = widget.agenda.deskripsi;
  }
